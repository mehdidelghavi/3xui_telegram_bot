...
exports.getServerById = async (serverId) => {
    try {
        const getServerById = await prisma.servers.findFirst({
            where: {
                id: Number(serverId)
            },
            include: {
        ...
        return {
            success: false,
            message: "متاسفانه سرور یافت نشد"
        }
    }
}
...
exports.saveToDb = async (data) => {
    try {
        const saveToDb = await prisma.servers.create({
            data: {
                settings: data
            }
        });
...
exports.updateServerById = async (serverId, data) => {
    try {
...
exports.deleteServerById = async (serverId) => {
    try {
